...
import { FormatConfigValues } from "../utils.js" // format config values
import { StdioClientTransport } from "@modelcontextprotocol/sdk/client/stdio.js"
import { getDefaultEnvironment } from "@modelcontextprotocol/sdk/client/stdio.js"
import { fetchConnection } from "../registry" // POST
...
import type { StdioConnection } from "../../types/registry"
...
export const createStdioRunner = async (
	...
	const setupTransport = async () => {
		...
		const stdioConnection = serverDetails.connections.find(
			(conn: { type: string }) => conn.type === "stdio",
		)
		if (!stdioConnection) {
